...
-- 2. 순서 상관없이 모든 테이블 삭제
DROP TABLE IF EXISTS container, cargo, request, offer, container_cargo, notification, chat_room, chat_participant, chat_message, scfi_data;
...
ALTER TABLE container ADD COLUMN completed_at DATETIME NULL COMMENT '운송 완료 시간';
